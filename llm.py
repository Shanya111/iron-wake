...
#
# Отчёт с 20 августа 2026 показывает не рынок вообще, а РАСКЛАД ДВИЖКА: пять условий,
...
ANALYST_PROMPT = (
    ...
    "объём последней закрытой часовой свечи против порога, есть ли ложный пробой, какой "
    ...
    "по тренду дневки и с запасом до цели.\n"
    ...
    "сейчас держать инструмент на виду или спокойно ждать. Начни с названия инструмента. "
...
ROUTER_PROMPT = (
    ...
    "(для log_trade — журнал разрешает любой тикер), верни сырой тикер в верхнем регистре.\n"
    "Коды инструментов:\n" + _instrument_catalog() + "\n\n"
