...
ANALYST_PROMPT = (
    ...
    "тренд по 6-часовым свечам и какую сторону он разрешает, ближайшие уровни с "
    "расстоянием в ATR, "
    ...
    "по тренду 6-часовых свечей, и требует решительного ОТБОЯ — закрытия у своего "
    "края свечи.\n"
    ...
    "Аномальный объём и силу отбоя движок проверяет на СИГНАЛЬНОЙ свече — той, что "
    "вернула цену за уровень. Сам прокол мог случиться раньше: если цена ушла за "
    "уровень и держалась там до трёх часов, а сейчас вернулась решительно и на "
    "объёме — это тоже ловушка, и сигнал будет. Прокол сам по себе сигналом не "
    "является никогда, сколько бы он ни длился.\n"
    "Решение движок принимает по последней ЗАКРЫТОЙ часовой свече биржи: пока час "
    "не кончился, сигнала не будет, каким бы ни выглядел график внутри часа.\n"
