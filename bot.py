...
def settings_text(user_id: int, is_admin: bool) -> str:
    ...
    return (
        ...
        "Кнопки идут лестницей: ниже по списку — реже сигналы, но лучше средняя "
        "сделка. Варианта, который выигрывал бы сразу по обоим столбцам, в списке "
        "нет — выбор честный, платишь частотой за качество.\n\n"
