...
#
# ФОРЕКС ИЗ ДВИЖКА УБРАН 2 сентября 2026 (решение владельца: движок только по крипте
...
# не просил.
#
# Отдельных порогов детектора у них больше нет: с 2 сентября ВСЕ пороги заданы в
...
def engine_codes() -> list[str]:
    ...
    Условий два, и второе появилось 2 сентября 2026. Источник объёма (data_source) —
...
def is_fx(code: str | None) -> bool:
    ...
    До 2 сентября 2026 флаг значил другое: «у пары свои пороги детектора». Теперь
