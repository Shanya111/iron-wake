...
### Тесты
`python tests/test_engine.py` — 74 юнит-теста аналитики, паттернов, ATR и двух фильтров
строгости, лимитного входа, трекинга исхода, стакана, разбора `explain()`, **порогов в
долях ATR**, **силы отбоя**, **минимальной цели** и **правила срабатывания алертов** на
синтетических данных (сети не требуют,
