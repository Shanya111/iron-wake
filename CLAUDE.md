...
### Тесты
`python tests/test_engine.py` — 70 юнит-тестов аналитики, паттернов, ATR и двух фильтров
строгости, лимитного входа, трекинга исхода, стакана, разбора `explain()`, **порогов в
долях ATR**, **силы отбоя** и **правила срабатывания алертов** на синтетических данных (сети не требуют,
...
- **сильные уровни ХУЖЕ слабых вдвое** (−0.127 против −0.050). Звёздочка в сигнале,
  помечающая уровень как приоритетный, по деньгам вводит в заблуждение;
